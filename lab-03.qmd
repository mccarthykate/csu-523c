...
> Quadrant distributions for the LISA maps are different between the two tessellations. On the hexagonal LISA map, there is more clear clustering. The concentration of dams on parts of the west coast practically dissappears in the hexagonal tessellation, because larger county size can influence interpretation of dam concentration. The county tessellation LISA map shows a more divergent local structure compared to the hexagonal tessellation. 
