...
```{r}
#cluster 
kmeans = kmeans(values, 5, iter.max = 100)
...
```{r}
clus_raster = landsat_cropped$coastal
...
clus_raster[idx] <- kmeans$cluster

plot(clus_raster, col = RColorBrewer::brewer.pal(5, "Paired"))
```
